...
env_params = {"data_path": training_data_path, "mode": mode, "sub_path": True}
...
optimizer_params = {
    ...
    "scheduler": {"milestones": [1 * i for i in range(1, 50)], "gamma": 0.97},
}
...
logger_params = {"log_file": {"desc": "train", "filename": "log.txt"}}
